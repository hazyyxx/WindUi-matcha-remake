...
s1:Toggle({ Title = "Auto farm",  Icon = "bot",      Value = false, Callback = function(v) notify("toggle "..tostring(v),"demo",2) end })
s1:Toggle({ Title = "God mode",   Icon = "shield",   Value = true })
s1:Slider({ Title = "Walk speed", Icon = "gauge",    Value = { Default = 16, Min = 16, Max = 200 }, Step = 1 })
s1:Button({ Title = "Teleport",   Icon = "navigation", Callback = function() notify("clicked","demo",2) end })
s1:Keybind({ Title = "Panic key", Icon = "keyboard", Value = "RShift" })
